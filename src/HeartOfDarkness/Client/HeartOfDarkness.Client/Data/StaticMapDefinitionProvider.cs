...
internal sealed class StaticMapDefinitionProvider : IMapDefinitionProvider {
	...
	private readonly MapDefinition _mapDefinition =
		new MapDefinition(
			...
			[
				new Position(1680, 2246), // 1
				new Position(1680, 2320), // 2
				new Position(1680, 2386), // 3
				new Position(1680, 2452), // 4
				new Position(1680, 2518), // 5
				new Position(1680, 2584), // 6
				new Position(1680, 2650), // 7
			]
		);
